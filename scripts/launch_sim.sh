...
export CYCLONEDDS_URI='<CycloneDDS><Domain id="any"><General><Interfaces><NetworkInterface name="wlp9s0"/></Interfaces><Peers><Peer address="10.10.10.9"/></Peers></General></Domain></CycloneDDS>'
