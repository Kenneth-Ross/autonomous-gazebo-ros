...
- Coordinated sender restart passed. Server stopped the sole encoder for eight seconds and started replacement PID 157550; edge observed 0 FPS outage, DDS rediscovery, 30.2 FPS recovery, queue maximum 1, and no transport errors. Evidence: `camera_server_sender_restart_20260721T201215Z.log` and `camera_edge_sender_restart_20260721T200938Z.log`.
