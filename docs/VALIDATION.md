...
- Corrected sender-restart rerun passed clean DDS zero-to-one transition: owned launcher/encoder stopped, eight-second outage observed at 0 FPS, replacement launcher/encoder started with exactly one publisher per stream, edge rediscovered DDS and recovered 30.4 FPS with queue maximum 1. Evidence: `camera_server_sender_restart_20260721T203232Z.log` and `camera_edge_sender_restart_20260721T203217Z.log`.
