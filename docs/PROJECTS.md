...
|---|---|---|---|---|
| `[W.I.P]` | 30 FPS simulation-to-edge RGB-D streaming | [Streaming contract](STREAMING_CONTRACT.md) | Split HEVC RGB/Zstd depth implementation, depth-8 exact-stamp receiver, newest-frame transport QoS, header-preserving direct Zstd decode, callback timestamp/rate diagnostics, MTU-safe DDS generation, strict nominal probes, DDS validation, and preflight | Pass host builds/tests; then retain Orange Pi nominal, adversarial, latency, bandwidth, depth, and soak evidence |
