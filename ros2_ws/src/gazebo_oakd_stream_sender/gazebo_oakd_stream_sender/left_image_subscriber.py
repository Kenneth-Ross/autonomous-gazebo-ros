...
class LeftImageSubscriber(Node):
    def __init__(self):
        super().__init__('left_image_subscriber')
        ...
        self.get_logger().info('Left Image Subscriber Node with GStreamer has been started.')
...
def main(args=None):
    ...
    left_image_subscriber = LeftImageSubscriber()
    try:
        rclpy.spin(left_image_subscriber)
    except KeyboardInterrupt:
        pass
    finally:
        left_image_subscriber.get_logger().info('Shutting down node.')
