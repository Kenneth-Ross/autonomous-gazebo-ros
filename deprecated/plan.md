...
**Note: This plan is deprecated. It describes a 3-stream approach that has been replaced by the Bit-Split single-stream strategy for RGB-D synchronization. See `docs/STREAMING_STRATEGY.md`.**
